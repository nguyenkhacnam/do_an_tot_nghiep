...
const steps = ["Chưa xác nhận", "Đã xác nhận", "Đã giao hàng"];
...
const Row = props => {
  ...
  const { row } = props;
  console.log("🚀 ~ file: index.js:61 ~ Row ~ row:", row)
  ...
  return (
    <React.Fragment>
      <TableRow
        sx={{ "& > *": { borderBottom: "set", backgroundColor: "white" } }}
      >
        <TableCell>
          <IconButton
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box sx={{ margin: 1 }}>
              ...
              <Table size="small" aria-label="purchases">
                <TableHead>
                  <TableRow>
                    <TableCell style={{ color: "black", fontSize: "13px" }}>
                      ID Sản phẩm
                    </TableCell>
                    <TableCell
                      align="center"
        ...
        >
          ...
          >
            <Stack
              direction="row"
              width="100%"
              sx={{ marginRight: "2rem", backgroundColor: "grey" }}
            >
          ...
          <ReactToPrint
            trigger={() => (
              <Button
                style={{ marginTop: "5%", width: "50%", marginLeft: "50%" }}
                variant="outlined"
              >
                Print / Download
              </Button>
