...
const FilterAccordion = props => {
  ...
  const [screenDimensionOptions, setScreenDimensionOptions] = useState({
    loading: false,
    options: [],
  });
  ...
  const [featureFilter, setFeatureFilter] = useState([
    { nameDisplay: "Nhà sản xuất", featureName: "Brand", option: brandOptions },
    { nameDisplay: "RAM", featureName: "RAM", option: ramOptions },
    { nameDisplay: "CPU", featureName: "CPU", option: cpuOptions },
    { nameDisplay: "GPU", featureName: "GPU", option: gpuOptions },
    {
      nameDisplay: "Màn hình",
      featureName: "Screen Dimension",
      option: screenDimensionOptions,
    },
    { nameDisplay: "Cân nặng", featureName: "Weight", option: weightOptions },
    { nameDisplay: "Ổ cứng", featureName: "Memory", option: memoryOptions },
    { nameDisplay: "Năm sản xuất", featureName: "Year", option: yearOptions },
  ]);
  useEffect(() => {
  ...
  return (
    <div>
      {featureFilter.map((item, i) => (
        <Accordion
          key={i}
          expanded={expanded === item.featureName}
          onChange={handleChange(item.featureName)}
        >
          <AccordionSummary
