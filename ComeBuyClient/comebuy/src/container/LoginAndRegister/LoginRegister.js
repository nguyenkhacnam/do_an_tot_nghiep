...
const LoginRegister = () => {
    ...
    if (emailUser === null) {
      ...
      if (passwordUser === null) {
        ...
        try {
          ...
          console.log(
            "🚀 ~ file: LoginRegister.js:263 ~ handleLogin ~ resultAction:",
            resultAction
          );
  ...
  const handleCreateAccount = async () => {
    ...
    //validate username
    if (
      dataForReg.name.length <= 5 ||
      dataForReg.name === "" ||
      Validation.CheckUsername(dataForReg.name)
    ) {
    ...
    <div className={`container ${addClass}`}>
        ...
        <div className="signin-signup">
          <form className="sign-up-form">
            ...
            >
              ...
              <TextField
                ...
                onChange={e =>
                  setDataForReg({ ...dataForReg, name: e.target.value })
                }
              />
              ...
              <TextField
                ...
                onChange={e =>
                  setDataForReg({ ...dataForReg, email: e.target.value })
                }
              />
              ...
              <Stack direction="row" width="100%" spacing={1.5}>
                <TextField
                  ...
                  onChange={e =>
                    setDataForReg({ ...dataForReg, password: e.target.value })
                  }
                />
                {passwordShown ? (
                  <IconButton
                    style={{ backgroundColor: "#ead1ea" }}
              ...
              >
                ...
                >
                  ...
                  <Typography id="modal-modal-description" sx={{ mt: 2 }}>
                    While we know it's easy to overlook these Terms of Service,
                    it's important to clarify our responsibilities and your
                    responsibilities during your use of Google services. These
                    Terms of Service reflect the way Google does business, the
                    laws our company must follow, and some of the things we have
                    always believed to be true. These Terms of Service therefore
                    help define Google's relationship with you when you interact
                    with our services. For example, these terms cover the
                    following topics: Our Responsibilities: This is a
                    description of how we deliver and develop our services Your
                    responsibilities: This section outlines some rules that you
                    must follow when using our services Content in Google
                    services: This section describes the intellectual property
                    rights to the content you see in our services, regardless of
                    whether it belongs to you, Google, or someone else. In the
                    event of a problem or disagreement: This section describes
                    other legal rights you have and what you should know in the
                    event someone violates these terms It is very important to
                    understand these terms because by using our services you
            ...
            {openDialogRegFailed ? (
              <Dialog
                open={openDialogRegFailed}
                onClose={handleCloseDialogRegFailed}
              >
          ...
          <form action="#" className="sign-in-form">
            ...
            {openPasswordLoginError ? (
              <Alert severity="warning">Type password</Alert>
            ) : null}
      ...
      <div className="panels-container">
        <div className="panel left-panel">
          <div className="content">
            ...
            >
              Sở hữu chiếc laptop tốt nhất trên ComeBuy luôn là sự lựa chọn tốt
              nhất của bạn
            </p>
            <button
        ...
        <div className="panel right-panel">
          <div className="content">
            ...
            >
              Hãy đăng nhập ngay bây giờ. Một điều gì đó hoàn hảo đang chờ đợi
              bạn
            </p>
            <button
              className="btn transparent"
        ...
        <Fab
          sx={{ position: "absolute", backgroundColor: "#EA8BFA" }}
          onClick={() => navigate("/")}
          size="small"
          color="secondary"
          aria-label="add"
      ...
      >
        <Alert
          ...
          sx={{ width: "100%" }}
        >
          Đã xảy ra lỗi! Vui lòng kiểm tra email và mật khẩu của bạn.
        </Alert>
      </Snackbar>
      <Backdrop
      ...
      <Snackbar open={openUsernameError} autoHideDuration={3000}>
        <Alert severity="error" sx={{ width: "auto" }}>
          Tên người dùng không được có độ dài dưới 5
        </Alert>
      </Snackbar>
